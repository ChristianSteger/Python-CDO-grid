...
def griddesc(file, gridtype, xsize, ysize, xfirst, yfirst, xinc, yinc,
             **kwargs):
    """Create CDO grid description file.
...
def griddesc_netcdf(file, lat_cent, lon_cent, lat_edge, lon_edge):
    """Create CDO grid description file with coordinate arrays.
    ...
    file: str
        Output name of text file
    lat_cent : array_like
        Array (2-dimensional) with latitudes of grid cell centres [deg]
    lon_cent : array_like
        Array (2-dimensional) with longitudes of grid cell centres [deg]
    lat_edge : array_like
        Array (2-dimensional) with latitudes of grid cell edges [deg]
    lon_edge : array_like
        Array (2-dimensional) with longitudes of grid cell edges [deg]
    ...
    if ((lat_cent.ndim != 2) or (lon_cent.ndim != 2) or
        ...
        raise TypeError("not all input arrays are two-dimensional")
